    ...
    <div class="page-container py-6">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="page-header">
          <div>
            <h1 class="page-title">Gestión de Menús</h1>
            <p class="page-subtitle">Administra los elementos del menú de navegación</p>
          </div>
          ...
          <div class="overflow-x-auto">
            <table class="table">
              ...
              <tbody class="table-body">
                <tr v-for="menu in menus.data" :key="menu.id" class="table-row">
                  <td class="table-cell font-medium">{{ menu.nombre }}</td>
                  <td class="table-cell-secondary">{{ menu.ruta }}</td>
                  <td class="table-cell">
                    <Badge variant="neutral">{{ menu.orden }}</Badge>
                  </td>
                  <td class="table-cell">
                    <Badge variant="info" v-if="menu.rol">{{ menu.rol.nombre }}</Badge>
                    <span v-else class="text-theme-tertiary text-sm">Todos</span>
                  </td>
                  <td class="table-cell">
                    <Badge :variant="menu.activo ? 'success' : 'error'">
                  ...
                  <td class="table-cell">
                    <div class="flex items-center justify-end gap-2">
                      ...
                      <Button variant="ghost" size="sm" @click="deleteMenu(menu.id)">
