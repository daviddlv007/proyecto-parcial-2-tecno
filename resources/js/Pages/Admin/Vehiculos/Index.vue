      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="page-header">
          <div>
            ...
            <p class="page-subtitle">Administración de flota vehicular</p>
          </div>
          ...
          <div class="overflow-x-auto">
            <table class="table">
              <thead class="table-header">
                <tr>
                  <th class="table-header-cell">Placa</th>
                  <th class="table-header-cell">Tipo</th>
                  <th class="table-header-cell">Marca/Modelo</th>
                  <th class="table-header-cell">Año</th>
                  <th class="table-header-cell">Estado</th>
                  <th class="table-header-cell text-right">Acciones</th>
                </tr>
              </thead>
              <tbody class="table-body">
                <tr v-for="vehiculo in vehiculos.data" :key="vehiculo.id" class="table-row">
                  <td class="table-cell font-medium">{{ vehiculo.placa }}</td>
                  <td class="table-cell-secondary">{{ vehiculo.tipo_vehiculo?.nombre }}</td>
                  <td class="table-cell">{{ vehiculo.marca }} {{ vehiculo.modelo }}</td>
                  <td class="table-cell">{{ vehiculo.anio }}</td>
                  <td class="table-cell">
                    <Badge :variant="getEstadoVariant(vehiculo.estado_vehiculo)">
                  ...
                  <td class="table-cell">
                    <div class="flex items-center justify-end gap-2">
                      ...
                      <Button variant="ghost" size="sm" @click="deleteVehiculo(vehiculo.id)">
